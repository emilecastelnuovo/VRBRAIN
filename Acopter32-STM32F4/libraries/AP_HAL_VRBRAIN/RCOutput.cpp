...
static inline long map(long value, long fromStart, long fromEnd, long toStart,
	long toEnd)
    {
...
{
case 0:
(TIMER2->regs)->CCER |= (uint16_t)TIM_CCER_CC2E;
break; // CH_1 : OC1B
case 1:
(TIMER2->regs)->CCER |= (uint16_t)TIM_CCER_CC3E;
break; // CH_2 : OC1A
case 2:
(TIMER2->regs)->CCER |= (uint16_t)TIM_CCER_CC4E;
break; // CH_3 : OC4C
case 3:
(TIMER3->regs)->CCER |= (uint16_t)TIM_CCER_CC2E;
break; // CH_4 : OC4B
case 4:
(TIMER3->regs)->CCER |= (uint16_t)TIM_CCER_CC3E;
break; // CH_5 : OC4A
case 5:
(TIMER3->regs)->CCER |= (uint16_t)TIM_CCER_CC4E;
break; // CH_6 : OC3C
case 6:
(TIMER4->regs)->CCER |= (uint16_t)TIM_CCER_CC3E;
break; // CH_7 : OC3B
case 7:
(TIMER4->regs)->CCER |= (uint16_t)TIM_CCER_CC4E;
break; // CH_8 : OC3A
